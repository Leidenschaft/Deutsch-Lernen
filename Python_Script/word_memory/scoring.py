...
##if(True):
##    line_1, = pyplot.plot(ability,ability, label='ideal estimation')
##    line_2, = pyplot.plot(ability,rmean_real, label='difficult problem')
##    line_3, = pyplot.plot(ability,rmean_real2, label='easy problem')
##    pyplot.legend(bbox_to_anchor=(0.45, 1),handles=[line_1,line_2,line_3])
##    pyplot.xlabel('real abiity')
##    pyplot.ylabel('expectation of estimated ability')
##    pyplot.show()
