...
urlpatterns = [
    ...
    url(r'^edit_check/show/\S*\.xml$',views.showedit,name='showedit'),
    url(r'^edit_check/del/\S*\.xml$',views.deledit,name='deledit'),
    url(r'^edit_check/acc/\S*\.xml$',views.accedit,name='accedit'),]
