        ...
        $(this).ajaxSubmit({
            ...
            success: function (response_txt) {
               // alert(response_txt);
                ...
                var new_word_html_body = $(response_txt).find("#wordbody").children("*");
                $(self.parent.frames["right_frame"].document).find('body').children("*").remove();
                new_word_html_body.appendTo($(self.parent.frames["right_frame"].document).find('body').first());
            },
